...
import { UploadToGithubModal } from "@/components/projects/UploadToGithubModal";
  ...
  if (projects.length === 0) {
    return (
      <div className="h-full overflow-y-auto py-8 px-4 sm:px-6 lg:px-12 max-w-4xl mx-auto flex flex-col justify-center items-center text-center space-y-6 relative">
        ...
        <FolderGit2 size={44} className="text-blue-500" />
    ...
    <div className="h-full overflow-y-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-12 pb-28 sm:pb-32 lg:pb-12 max-w-[1600px] mx-auto space-y-8 scroll-smooth">
                ...
                <div className="flex items-center gap-2">
                  {user && (
                    <Button
                      ...
                      variant="outline"
                      className="h-9 px-3.5 rounded-xl border-slate-300 dark:border-white/15 hover:border-blue-500/50 hover:bg-slate-100 dark:hover:bg-white/[0.06] text-slate-800 dark:text-slate-200 text-xs font-bold shadow-xs flex items-center gap-1.5 cursor-pointer"
                  ...
                  <Button
                    ...
                    className="h-9 px-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold shadow-xs flex items-center gap-1.5 cursor-pointer"
                  >
                    <Code2 size={13} />
      ...
      {currentProj && (
        <UploadToGithubModal
          ...
          userHandle={username || user?.user_metadata?.username}
        />
      )}
    </div>
  );
