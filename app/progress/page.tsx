      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <BookOpen size={20} className="text-emerald-600 dark:text-emerald-400 shrink-0" />
          </div>
          <div className="mt-2 flex items-baseline gap-1.5">
            <span className="text-3xl font-black font-mono text-slate-900 dark:text-white">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <Flame size={20} className="text-amber-600 dark:text-amber-400 shrink-0" />
          </div>
          <div className="mt-2 flex items-baseline gap-1.5">
            <span className="text-3xl font-black font-mono text-slate-900 dark:text-white">
              {streakInfo.current}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <Terminal size={20} className="text-purple-600 dark:text-purple-400 shrink-0" />
          </div>
          <div className="mt-2 flex items-baseline gap-1.5">
            <span className="text-3xl font-black font-mono text-slate-900 dark:text-white">
