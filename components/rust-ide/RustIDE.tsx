        ...
        <div className="flex items-center gap-1.5 px-2 shrink-0">
          ...
          {onToggleFullScreen && (
            <Button
              ...
              size="sm"
              className={cn(
                "h-8 px-2 sm:px-2.5 rounded-xl text-xs font-semibold gap-1.5 transition-all cursor-pointer active:scale-95",
                isFullScreen
                  ? "bg-blue-600 hover:bg-blue-500 text-white border border-blue-500 shadow-md shadow-blue-500/20"
                  : "text-slate-500 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-white/[0.06]"
              )}
            ...
            >
              ...
              {isFullScreen && (
                <kbd className="hidden lg:inline-block ml-0.5 px-1 py-0.2 rounded bg-black/25 text-[9px] font-mono text-white/90 border border-white/20">
                  ⎋ Esc
                </kbd>
              )}
            </Button>
