      ...
      <div className="flex items-center gap-1.5 shrink-0 ml-auto">
        ...
        <div className="hidden md:flex items-center gap-1.5 pl-1.5 border-l border-slate-200/60 dark:border-white/[0.06]">
          <select
            ...
            className="h-[30px] rounded-lg border border-slate-200/70 dark:border-white/[0.08] bg-white/75 dark:bg-white/[0.05] px-2 text-[11px] font-mono text-slate-700 dark:text-slate-300 outline-none backdrop-blur-md"
          >
