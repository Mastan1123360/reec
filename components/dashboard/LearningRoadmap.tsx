  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {/* Navigation Arrows - appear only when pointer is on that section, idle after 3s cooldown */}
        <div
          className={cn(
        ...
        >
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-xl border border-border/70 bg-card/80 text-foreground hover:bg-primary hover:text-primary-foreground transition-all shadow-sm active:scale-95 disabled:opacity-30 disabled:pointer-events-none cursor-pointer"
      ...
      {/* Track with Linear Smooth Scrolling */}
      <div
        ref={scrollRef}
        className="flex items-stretch gap-4 overflow-x-auto pb-4 pt-1 px-1 scroll-smooth scrollbar-none no-scrollbar"
